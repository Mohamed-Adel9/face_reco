...
class AnnModel :
    s = 100
    output = 10
    DATADIR = "D://Study//3rd Year//1St Term//Projects//face recognition - Copy//face recognition - Copy//dataset//training and test"
    code = {'Adriana Lima': 0, 'Ben Affleck': 1, 'Bill Gates': 2, 'Cristiano Ronaldo': 3, 'Emilia Clarke': 4,
            'Emma Watson': 5,'Lionel Messi': 6, 'Mark Zuckerberg': 7, 'Shakira Isabel Mebarak': 8, 'Tom Holland': 9}
...
obj1 = AnnModel()
img_path = "D:\\Study\\3rd Year\\1St Term\\Projects\\face recognition - Copy\\face recognition - Copy\\dataset\\predict\\Emma Watson0_1841.jpg"
